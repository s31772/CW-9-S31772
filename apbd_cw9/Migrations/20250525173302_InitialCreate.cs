    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Medicament_Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Prescription_Medicament", x => new { x.Medicament_Id, x.Prescription_Id });
                    table.ForeignKey(
                        name: "FK_Prescription_Medicament_Medicament_Medicament_Id",
                        column: x => x.Medicament_Id,
                        principalTable: "Medicament",
                        principalColumn: "IdMedicament",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescription_Medicament_Prescription_Prescription_Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescription_Medicament_Prescription_Id",
